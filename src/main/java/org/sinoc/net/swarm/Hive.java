...
import org.sinoc.net.rlpx.discover.table.NodeEntry;
import org.sinoc.net.rlpx.discover.table.NodeTable;
import org.sinoc.net.swarm.bzz.BzzPeersMessage;
import org.sinoc.net.swarm.bzz.BzzProtocol;
import org.sinoc.net.swarm.bzz.PeerAddress;
...
public class Hive {
     ...
     *  ({@link org.sinoc.net.swarm.Hive.HiveTask#expireTime} and a limited number of
     *  peers to process ({@link org.sinoc.net.swarm.Hive.HiveTask#maxPeers}).

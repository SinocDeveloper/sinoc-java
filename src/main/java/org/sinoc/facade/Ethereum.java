...
public interface Ethereum {
     ...
     * and decoded with {@link org.sinoc.core.CallTransaction.Function#decodeResult(byte[])}.
     */
...
//  2.   // is blockchain still loading - if buffer is not empty
     ...
     * want to get accurate recommended gas price use {@link org.sinoc.listener.RecommendedGasPriceTracker}
     ...
     * @return Future, which completes when syncDone is turned to True in {@link org.sinoc.sync.SyncManager}
     */

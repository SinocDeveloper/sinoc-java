...
import static org.sinoc.util.ByteUtil.ZERO_BYTE_ARRAY;
...
import org.sinoc.crypto.ECKey.ECDSASignature;
import org.sinoc.crypto.ECKey.MissingPrivateKeyException;

...
(function() {
    ...
    function HomeCtrl($scope, $timeout, $http, $q, scrollConfig) {
        ...
        var mineStatuses = {
    		...
    		'PLOTFILE_CHECK':'Check Plot File',//检查挖矿文件
            'PLOTFILE_CHECK_ERROR':'Check Plot File Error',//检查挖矿文件错误
            'PLOTFILE_GENERATE_START':'Start Generate Polt File',//启动生成挖矿文件
            'PLOTFILE_READY':'Ready Plot File'//挖矿文件就绪
        };
        ...
        $(window).ready(function() {
            ...
            $('#testPortsLink').click(function() {
                ...
                var ports = [$scope.ethPort, $scope.vm.data.rpcPort];debugger;
                var promises = ports
                    .map(function(port, i) {
